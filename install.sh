...
sudo mkdir -p $HOMEDIR/.config/wireshark/
sudo cp Files/Wireshark/preferences $HOMEDIR/.config/wireshark/preferences
sudo cp Files/Wireshark/recent $HOMEDIR/.config/wireshark/recent


# Create launcher icons on the desktop
sudo mkdir -p $HOMEDIR/Desktop
sudo cp Files/System/Desktop/*  $HOMEDIR/Desktop
sudo chmod u+x $HOMEDIR/Desktop/*.desktop
sudo mkdir -p $HOMEDIR/.local/icons
sudo cp Files/System/Icons/*  $HOMEDIR/.local/icons
